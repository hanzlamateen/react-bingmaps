		...
		key: 'setPushPins',
            value: function setPushPins(pushPins, mapReference) {
                Microsoft.Maps.loadModule("Microsoft.Maps.Clustering", function () {
                    ...
                    var pins = Microsoft.Maps.TestDataGenerator.getPushpins(100, map[mapReference].getBounds());

                    //Create a ClusterLayer and add it to the map.
                    customLayer = new Microsoft.Maps.Layer(pins);
                    map[mapReference].layers.insert(customLayer);
                    console.log(`Is layer visible? ${customLayer.getvisible()}`);
                    //map[mapReference].entities.push(pins);
                })
		}
	}, {
		key: 'setInfoboxes',
