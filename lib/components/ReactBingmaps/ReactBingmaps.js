		...
		key: 'setInfoboxesWithPushPins',
            value: function setInfoboxesWithPushPins(infoboxesWithPushPins, infoboxCreateType, mapReference) {
                ...
                Microsoft.Maps.loadModule("Microsoft.Maps.Clustering", function () {
                    ...
                    //Create a ClusterLayer and add it to the map.
                    let clusterLayer = new Microsoft.Maps.ClusterLayer(clusterLayerArr, { clusteredPinCallback: that.getClusteredPinsInfo(mapReference)});
                    map[mapReference].layers.insert(clusterLayer);
                })
			}
        }, {
            ...
            value: function getClusteredPinsInfo(cluster, mapReference) {
                ...
                Microsoft.Maps.Events.addHandler(cluster, "mouseover", this.showClusterInfobox(mapReference));
            }
        }, {
            key: 'showClusterInfobox',
            value: function showClusterInfobox(e, mapReference) {
                let description = [];
