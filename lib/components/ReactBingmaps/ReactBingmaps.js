	...
	_createClass(ReactBingmaps, [{
		...
		key: 'setInfoboxesWithPushPins',
            ...
            value: function getClusteredPinsInfo(cluster) {
                let mapRef = this.mapReference;
                Microsoft.Maps.Events.addHandler(cluster, "click", this.props.clusterClickCallback);
                Microsoft.Maps.Events.addHandler(cluster, "mouseover", this.showClusterInfobox);
            }
        }, {
            ...
            value: function showClusterInfobox(e) {
                ...
                let infobox = new Microsoft.Maps.Infobox(this.mapRef.getCenter(), {visible: false})
